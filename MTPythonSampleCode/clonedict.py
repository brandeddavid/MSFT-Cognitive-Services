    ...
    with open('out.csv', 'a') as l:
        ...
        with open('test.csv','r') as f:
            ...
            for item in reader:
                ...
                #Translate to Russia
                translateRUUrl = "http://api.microsofttranslator.com/v2/Http.svc/Translate?text={}&to={}".format(item[0], 'ru')
                ...
                translateESUrl = "http://api.microsofttranslator.com/v2/Http.svc/Translate?text={}&to={}".format(item[0], 'es')
                ...
                #Translate to Dutch
                translateNLUrl = "http://api.microsofttranslator.com/v2/Http.svc/Translate?text={}&to={}".format(item[0], 'nl')
